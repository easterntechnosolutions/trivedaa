...
<!-- Page Title -->
<section class="banner-header banner-img valign bg-img bg-fixed" data-overlay-darkgray="0" style='z-index: 2; background-image:url("<?php echo $feaured_image; ?>"); background-position:bottom;'>
