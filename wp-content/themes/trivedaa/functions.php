...
function enqueue_scripts_function() {
	...
	if (!is_admin()) {
		...
		wp_enqueue_style ( 'magnificpopupcss', get_stylesheet_directory_uri() . '/css/plugins/magnific-popup.css' );
		wp_enqueue_style ( 'owlcarouselmincss', get_stylesheet_directory_uri() . '/css/plugins/owl.carousel.min.css' );
